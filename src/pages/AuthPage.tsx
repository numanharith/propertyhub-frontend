  ...
  const getTitleAndSubtitle = () => {
    switch (currentForm) {
      case "login":
        return {
          title: "Welcome Back!",
          subtitle: "Login to continue your property journey.",
        };
      case "register":
        return {
          title: "Create Your Account",
          subtitle: "Join PropertyHub to find or list properties.",
        };
      case "forgotPassword":
        return {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white p-8 md:p-10 rounded-xl shadow-2xl">
          <div className="text-center mb-8">
            <h2 id="auth-title" className="text-3xl font-bold text-primary">
              {title}
            </h2>
            <p id="auth-subtitle" className="text-gray-600 mt-2">
              {subtitle}
            </p>
          </div>
          ...
          {currentForm === "forgotPassword" && (
            <>
              ...
              <p className="text-center text-red-500">
                Forgot Password form not implemented yet.
              </p>
              <p className="mt-6 text-center text-sm text-gray-600">
